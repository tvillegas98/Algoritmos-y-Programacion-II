...
//Recorre el arbol con un recorrido inorder en un determinado rango, aplicando la funcion visitar en cada
//par clave,dato.
//Args:
//      arbol(abb_t*):ABB
//      visitar(bool)(const char*, void*,void*):Funcion de callback utilizada en cada par clave,dato.
//      extra(void*):Dato extra en caso de que el usuario quiera guardar datos
//      inicio(const char*):Primer elemento dentro del rango de claves
//      fin(const char*):Ultimo elemento dentro del rango de claves
